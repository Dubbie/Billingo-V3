...
class CurrencyApi
{
    ...
    {
        list($response) = $this->getConversionRateWithHttpInfo($from, $to);
        return $response;
    }
     ...
     */
    public function getConversionRateWithHttpInfo($from, $to)
    {
        $returnType = '\Swagger\Client\Model\ConversationRate';
        $request = $this->getConversionRateRequest($from, $to);
     ...
     */
    public function getConversionRateAsync($from, $to)
    {
        return $this->getConversionRateAsyncWithHttpInfo($from, $to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getConversionRateAsyncWithHttpInfo($from, $to)
    {
        $returnType = '\Swagger\Client\Model\ConversationRate';
        $request = $this->getConversionRateRequest($from, $to);
     ...
     */
    protected function getConversionRateRequest($from, $to)
    {
