...
class ProductApi
{
     ...
     */
    public function listProduct($page = null, $per_page = '25')
    {
        list($response) = $this->listProductWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function listProductWithHttpInfo($page = null, $per_page = '25')
    {
        $returnType = '\Swagger\Client\Model\ProductList';
        $request = $this->listProductRequest($page, $per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProductAsync($page = null, $per_page = '25')
    {
        return $this->listProductAsyncWithHttpInfo($page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProductAsyncWithHttpInfo($page = null, $per_page = '25')
    {
        $returnType = '\Swagger\Client\Model\ProductList';
        $request = $this->listProductRequest($page, $per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listProductRequest($page = null, $per_page = '25')
    {
